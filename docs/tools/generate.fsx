...
let githubLink = "http://github.com/Update GitHome in build.fsx/js2html"

// Specify more information about your project
let info =
  [ "project-name", "js2html"
    "project-author", "Update Author in build.fsx"
    "project-summary", "Dotliquid templating for json objects"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/js2html" ]
